...
import {React,TextField,useEffect,plugin_for_contact,Select,MenuItem,MuiThemeProvider,colortheme,Button,useState} from './Import'
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row mt-4">
                                        ...
                                        <div className="col-lg">
                                            ...
                                            <TextField className="form-control" type="text" style={{'marginTop':'0.8rem'}}  name="req_name" id="req_name" onChange={inputEvent}/>
                                        </div>

                                        {/* requester Contact */}
                                        <div className="col-lg">
                                            <label htmlFor="req_contact_no" className="mt-2">Contact</label>
                                            <TextField className="form-control"  style={{'marginTop':'0.8rem'}}  type="text" name="req_contact_no" id="req_contact_no" onChange={inputEvent}/>
                                        </div>
                                        
                                        {/* Aadhar Card/Ration Card Number */}
                                        <div className="col-lg">
                                            <label htmlFor="card_no" className="mt-2">Aadhar/Ration Card No</label>
                                            <TextField className="form-control" style={{'marginTop':'0.8rem'}} type="text" name="card_no" id="card_no" onChange={inputEvent} />
                                        </div>

                                         {/* Card Type */}
                                         <div className="col-lg">
                                            <label htmlFor="card_type" className="mt-2">Select Card-type</label>
                                            <Select name="card_type" id="card_type" className="form-control border-0" value={request_details.card_type} onChange={inputEvent}>
                                    ...
                                    <div className="row mt-4">
                                         ...
                                         <div className="col-lg-3">
                                            ...
                                            <TextField className="form-control" type="number" name="dependent_no" id="dependent_no" onChange={inputEvent}  />
                                        </div>
                                        ...
                                        <div className="col-lg-4">
                                            ...
                                            <TextField className="form-control"  type="number" name="children_no" id="children_no" onChange={inputEvent} />
                                        </div>   

                                        {/* Occupation */}
                                        <div className="col-lg">
                                            <label htmlFor="occupation" className="mt-2">Occupation</label>
                                            <TextField className="form-control"  type="text" name="occupation" id="occupation" onChange={inputEvent} />
                                        </div>                                        
                                    </div>
                                    ...
                                    <div className="row mt-4">
                                        ...
                                        <div className="col-lg-6">
                                            ...
                                            <TextField className="form-control mt-0" type="text" name="address" id="address" onChange={inputEvent}  />
                                        </div>

                                        {/* Area/location */}
                                        <div className="col-lg-6">
                                            <label htmlFor="location" className="mt-2">Area/Location</label>
                                            <TextField className="form-control mt-0" type="text" name="location" id="location" onChange={inputEvent}  />
                                        </div>      
                                    </div>  
                                </div>
                            </div>
                               ...
                               <div className="card-body">
                                    ...
                                    <div className="row mt-4">
                                        ...
                                        <div className="col-lg">
                                            ...
                                            <TextField className="form-control mt-0" type="text" name="jamat_name" id="jamat_name" onChange={inputEvent}  />
                                        </div>

                                         {/* Contact person */}
                                        <div className="col-lg">
                                            <label htmlFor="contact_person" className="mt-2" >Contact Person</label>
                                            <TextField className="form-control mt-0"  type="text" name="contact_person" id="contact_person" onChange={inputEvent} />
                                        </div>

                                       {/* Contact */}
                                       <div className="col-lg">
                                            <label htmlFor="cp_contact_no" className="mt-2">Contact Person Contact No</label>
                                            <TextField className="form-control"  type="text" name="cp_contact_no" id="cp_contact_no" onChange={inputEvent} />
                                       </div>
                                    </div>
