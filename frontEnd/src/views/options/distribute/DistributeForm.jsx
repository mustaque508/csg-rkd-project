                                        ...
                                        <div className="col-lg-4 col-md-6  mt-3">
                                            <label htmlFor="area">Quantity (kg) </label>
                                                <BootstrapTooltip title={qty_error} open={open} placement={tooltip_position}>
                                                    <TextField type="number" inputProps={{ min: "0", step: "1" }} id="qty" name="qty" className="form-control mt-1" onChange={inputEvent}   onSelect={hideToolTip}  />
                                                </BootstrapTooltip>
                                        </div>
                                        ...
                                        <div className="col-lg-4 col-md-6  mt-3">
                                            <label htmlFor="data_collected">Data collected ?</label>
                                                <BootstrapTooltip title={data_collected_error} open={open} placement={tooltip_position}>
                                                    <Select id="data_collected" name="data_collected" value={distribute_details.data_collected}className="w-100 mt-1"  onChange={inputEvent}   onMouseOver={hideToolTip} >
                                        ...
                                        <div className="col-lg-4 col-md-6  mt-3">
                                            <label htmlFor="contact_person">Contact Person Contact No</label>
                                                <BootstrapTooltip title={cp_contact_error} open={open} placement={tooltip_position}>
                                                    <TextField type="text" id="cp_contact_no" name="cp_contact_no" className="form-control mt-1 " onChange={inputEvent}  onKeyUp={hideToolTip} />
                                                </BootstrapTooltip>
                                        </div>
