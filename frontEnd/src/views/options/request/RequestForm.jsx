                                ...
                                <div className="row">
                                     ...
                                     <div className="col-lg-4 col-md-12 mt-3">
                                        ...
                                        <BootstrapTooltip title={req_name_error} open={open} placement={tooltip_position}>
                                            <TextField  id="req_name" type="text" name="req_name" className="form-control mt-1" onChange={inputEvent} onSelect={hideToolTip} />
                                        </BootstrapTooltip>
                                    </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 mt-3 ">
                                        ...
                                        <BootstrapTooltip title={req_contact_no_error} open={open} placement={tooltip_position}>
                                            <TextField  id="req_contact_no"   type="text" name="req_contact_no" className="form-control mt-1 " onChange={inputEvent} onSelect={hideToolTip} />
                                        </BootstrapTooltip>
                                    </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 mt-3 ">
                                        ...
                                        <BootstrapTooltip  title={card_no_error} open={open} placement={tooltip_position}>
                                            <TextField  id="card_no"   type="text" name="card_no" className="form-control mt-1 " onChange={inputEvent} onSelect={hideToolTip} />
                                        </BootstrapTooltip> 
                                    </div>
                                    ...
                                    <div className="col-lg-4  col-md-6 mt-3 "> 
                                        ...
                                        <BootstrapTooltip title={req_card_type_error} open={open} placement={tooltip_position}>
                                            <Select id="card_type" name="card_type" className="w-100 mt-1" value={request_details.card_type}  onChange={inputEvent} onMouseOver={hideToolTip}  >
                                    ...
                                    <div className="col-lg-4 col-md-6 mt-3  ">
                                        ...
                                        <BootstrapTooltip title={dependent_no_error} open={open} placement={tooltip_position}>
                                            <TextField  className="form-control mt-1" inputProps={{ min: "0", step: "1" }} id="dependent_no" type="number" name="dependent_no"  onChange={inputEvent} onSelect={hideToolTip}/>
                                        </BootstrapTooltip>
                                    </div>
                                    ...
                                    <div className="col-lg-4 col-md-6 mt-3 ">
                                        ...
                                        <BootstrapTooltip title={children_no_error} open={open} placement={tooltip_position}>
                                            <TextField  className="form-control mt-1" inputProps={{ min: "0", step: "1" }} id="children_no" type="number" name="children_no"  onChange={inputEvent} onClick={hideToolTip}/>
                                        </BootstrapTooltip>
                                    </div>
                                ...
                                <div className="row">
                                    ...
                                    <div className="col-lg-4 col-md-6  mt-3">
                                        ...
                                        <BootstrapTooltip title={cp_contact_error} open={open} placement={tooltip_position}>
                                                <TextField className="form-control mt-1" id="cp_contact_no"  type="text" name="cp_contact_no" onChange={inputEvent}    onSelect={hideToolTip}/>
                                        </BootstrapTooltip>
                                    </div>
